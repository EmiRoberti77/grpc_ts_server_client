...
export interface RamdomClient extends grpc.Client {
  ...
  RandomNumbers(metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientDuplexStream<_randomPackage_NumberRequest, _randomPackage_NumberResponse__Output>;
  RandomNumbers(options?: grpc.CallOptions): grpc.ClientDuplexStream<_randomPackage_NumberRequest, _randomPackage_NumberResponse__Output>;
  randomNumbers(metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientDuplexStream<_randomPackage_NumberRequest, _randomPackage_NumberResponse__Output>;
  randomNumbers(options?: grpc.CallOptions): grpc.ClientDuplexStream<_randomPackage_NumberRequest, _randomPackage_NumberResponse__Output>;
  
}

export interface RamdomHandlers extends grpc.UntypedServiceImplementation {
  PingPong: grpc.handleUnaryCall<_randomPackage_PingRequest__Output, _randomPackage_PongResponse>;
  
  RandomNumbers: grpc.handleBidiStreamingCall<_randomPackage_NumberRequest__Output, _randomPackage_NumberResponse>;
  
}

export interface RamdomDefinition extends grpc.ServiceDefinition {
